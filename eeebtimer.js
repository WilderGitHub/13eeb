var ringer = {
  ...
  countdown_to: "08/07/2020 11:30:00",
  rings: {
    /*  'HORAS': {
  ...
  go: function () {
    ...
    if ($r.time >= 0) {
      document.getElementById("mensajito").innerHTML =
        "El evento iniciará en breve";
      document.getElementById("mensajito").style.color = "black";
      $r.time = 0;
  ...
  unit: function (idx, label, ring) {
    ...
    // second circle
    $r.ctx.strokeStyle = "rgba(185, 142, 2,0.9)";
    $r.ctx.strokeStyle = "rgba(185, 142, 2, 0.9)";
    $r.ctx.beginPath();
    ...
    $r.ctx.font = "bold 70px Helvetica";
